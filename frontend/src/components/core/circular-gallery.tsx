...
function createTextTexture(gl: OGLContext, text: string, font = "bold 30px sans-serif", color = "white") {
...
class App {
  ...
  createMedias(items: CircularGalleryItem[], bend: number, textColor: string, borderRadius: number, font: string) {
